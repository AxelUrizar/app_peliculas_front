            ...
            <div className="container mt-5 d-flex flex-column justify-content-evenly">
                <div className="row d-flex justify-content-center">
                    ...
                    <div className="col-3 d-flex flex-column justify-content-center">
                        <Link to={`editarPerfil`}><button className="btn btn-danger rounded-pill my-3" type="submit">Editar Perfil</button></Link>
                        <Link to='/' onClick={logout}><button className="btn btn-danger rounded-pill my-3">Log Out</button></Link>
                    </div>
                </div>
